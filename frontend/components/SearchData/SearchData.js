...
const DEFAULT_PROMPT_MESSAGES = [
  ...
  {
    prompt:
      "Give me the score for token _TOKEN_ADDRESS_ on the _NETWORK_ network",
    example:
  ...
  {
    prompt:
      "Give me pool liquidity score for token _TOKEN_ on the _NETWORK_ network",
    example:
      "Give me pool liquidity score for token 0xa29fe6ef9592b5d408cca961d0fb9b1faf497d6d on the Ethereum network",
    category: "Finance",
  },
  {
    prompt:
    ...
    example:
      "Give me top gainer tokens on the Ethereum network for 5m time period.",
    category: "Token",
  },
  {
    prompt:
    ...
    example:
      "Give me top loser tokens on the Ethereum network for 5m time period.",
    category: "Token",
  },
  {
  ...
  {
    prompt: "Give me top exchange list based on volume on ethereum network.",
    example: "Give me top exchange list based on volume on ethereum network.",
    category: "Exchange",
  },
  {
    prompt: "Give me top exchange list based on pool size on ethereum network.",
    example: "Give me top exchange list based on pool size on ethereum network.",
    category: "Exchange",
  },
  {
    prompt: "Give me top exchange list based on swaps on ethereum network.",
    example: "Give me top exchange list based on swaps size on ethereum network.",
    category: "Exchange",
  },
];
