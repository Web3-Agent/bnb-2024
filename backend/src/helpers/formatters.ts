...
export function greaterThan(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).comparedTo(new BigNumber(`${numberTwo}`)) === 1;
}

export function greaterThanOrEqual(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).comparedTo(new BigNumber(`${numberTwo}`)) >= 0;
}

export function smallerThan(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).comparedTo(new BigNumber(`${numberTwo}`)) === -1;
}

export function smallerThanOrEqual(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).comparedTo(new BigNumber(`${numberTwo}`)) <= 0;
}

export function multiply(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).times(new BigNumber(`${numberTwo}`)).toString();
}

export function divide(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).dividedBy(new BigNumber(`${numberTwo}`)).toString();
}

export function floorDivide(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).dividedToIntegerBy(new BigNumber(`${numberTwo}`)).toString();
}

export function mod(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).mod(new BigNumber(`${numberTwo}`)).toString();
}

export function add(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).plus(new BigNumber(`${numberTwo}`)).toString();
}

export function subtract(numberOne: any, numberTwo: any) {
    return new BigNumber(`${numberOne}`).minus(new BigNumber(`${numberTwo}`)).toString();
}

export function convertAmountToRawNumber(value: any, decimals = 18) {
    return new BigNumber(`${value}`).times(new BigNumber("10").pow(decimals)).toString();
}

export function convertAmountFromRawNumber(value: any, decimals = 18) {
...
//     }
//     let result: any = new BigNumber(`${value}`).toFixed(decimals);
...
export function formatFixedDecimals(value: any, decimals: any) {
...
export function formatInputDecimals(inputOne: any, inputTwo: any) {
    const _nativeAmountDecimalPlaces: any = countDecimalPlaces(inputTwo);
